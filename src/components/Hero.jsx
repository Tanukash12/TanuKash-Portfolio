...
const Hero = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      id="home"
      className="relative max-w-7xl mx-auto px-6 pt-32 pb-20 flex flex-col md:flex-row items-center justify-between"
    >
      {/* LEFT TEXT */}

      <div ref={textRef} className="max-w-xl">
        <p className="text-sm text-white/50 mb-4 italic tracking-wide">
        ...
        <p className="mt-6 text-gray-400 leading-8 mb-6 max-w-xl text-justify">
          ...
          constantly exploring and learning. Currently, I’m focused on
          full-stack development with MERN, strengthening my Java & DSA skills,
          diving deeper into SQL, and building a strong foundation in core
          computer science.
        </p>
